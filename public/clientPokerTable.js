...
socket.on('update', function(gameData) {
	...
	console.log(gameData);
		...
		document.getElementById('seat1Stack').innerHTML='Stack: ' + gameData.game_info.seatList.seat1.balance;
		document.getElementById('seat2Name').innerHTML='Player 2: ' + gameData.game_info.seatList.seat2.name;
		document.getElementById('seat2Stack').innerHTML='Stack: ' + gameData.game_info.seatList.seat2.balance;
		document.getElementById('seat3Name').innerHTML='Player 3: ' + gameData.game_info.seatList.seat3.name;
		document.getElementById('seat3Stack').innerHTML='Stack: ' + gameData.game_info.seatList.seat3.balance;
		document.getElementById('seat4Name').innerHTML='Player 4: ' + gameData.game_info.seatList.seat4.name;
		document.getElementById('seat4Stack').innerHTML='Stack: ' + gameData.game_info.seatList.seat4.balance;
		document.getElementById('seat5Name').innerHTML='Player 5: ' + gameData.game_info.seatList.seat5.name;
		document.getElementById('seat5Stack').innerHTML='Stack: ' + gameData.game_info.seatList.seat5.balance;
		document.getElementById('seat6Name').innerHTML='Player 6: ' + gameData.game_info.seatList.seat6.name;
		document.getElementById('seat6Stack').innerHTML='Stack: ' + gameData.game_info.seatList.seat6.balance;
		document.getElementById('seat7Name').innerHTML='Player 7: ' + gameData.game_info.seatList.seat7.name;
		document.getElementById('seat7Stack').innerHTML='Stack: ' + gameData.game_info.seatList.seat7.balance;
		document.getElementById('seat8Name').innerHTML='Player 8: ' + gameData.game_info.seatList.seat8.name;
		document.getElementById('seat8Stack').innerHTML='Stack: ' + gameData.game_info.seatList.seat8.balance;
		document.getElementById('seat9Name').innerHTML='Player 9: ' + gameData.game_info.seatList.seat9.name;
		document.getElementById('seat9Stack').innerHTML='Stack: ' + gameData.game_info.seatList.seat9.balance;
