  ...
  if(process.env.NODE_ENV === 'production')
    ...
    render() { 
      ...
      if(this.props.my_id==null){
        ...
        return (
        <Navbar>
            <LoginModal defaultLoginModalTab={this.props.defaultLoginModalTab} showLoginError={this.props.showLoginError} ref={this.loginModalRef} loginModalOpen={this.props.loginModalOpen} toggleLoginModal={this.props.toggleLoginModal.bind(this)} login={this.props.login.bind(this)} ></LoginModal>
