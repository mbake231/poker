...
this.timeout(20000);
	...
	it('all in that gets fold on',function (done){
		let game1 = new game('test',null,100,200,false);		let mike = new player("5e83a80f4aeeda2c0a258d4f",100000,'playing','sid');
	...
	it('fold out on blinds',function (done){
		let game1 = new game('test',null,100,200,false);		let mike = new player("5e83a80f4aeeda2c0a258d4f",29000,'playing','sid');
	...
	let game1 = new game('test',null,100,200,false);	let mike = new player("5e83a80f4aeeda2c0a258d4f",10500,'playing','sid');
	...
	it('boring check game',function (done){
		let game1 = new game('test',null,100,200,false);		let mike = new player("5e83a80f4aeeda2c0a258d4f",10000,'playing','sid');
		let kev = new player("5e83ab2844d4db2d4038c095",10000,'playing','sid');
		let shane = new player("5e83aa9a64ca552d1437f9f3",10000,'playing','sid');
	...
	it('ensureing fold  on irver works due to a bug', function (done) {
		let game1 = new game('test',null,100,200,false);		let mike = new player("5e83a80f4aeeda2c0a258d4f",4200,'playing','sid');
		let kev = new player("5e83ab2844d4db2d4038c095",5000,'playing','sid');
	...
	it('all in on blinds and caller can cover', function (done) {
		let game1 = new game('test',null,100,200,false);		
